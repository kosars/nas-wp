...
<?php if($gallery_default_params['gallery_img_view9_general_position'] == 'center') { echo 'margin:-27px auto;'; }?>;
    ...
    border-bottom: <?php echo $gallery_default_params['gallery_img_ht_view9_general_separator_size']; ?> px <?php if($gallery_default_params['gallery_img_view9_general_separator_style'] == 'none') { echo 'none'; }
...
.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?> .like_font_active {
<?php if($gallery_default_params['gallery_img_ht_blog_rating_count'] != 'off'):?> color: # <?php echo $gallery_default_params['gallery_img_ht_blog_active_font_color']; ?> !important;
<?php endif; ?>
}
