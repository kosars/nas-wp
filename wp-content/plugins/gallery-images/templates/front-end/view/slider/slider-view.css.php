...
<?php //if($gallery_default_params['gallery_img_slider_crop_image') == "resize"){?> width: 100%;
    height: 100%;
    left: 0;
    top: 0;
...
<?php  if($gallery_default_params['gallery_img_slider_description_has_margin'] == 'on'){
    ...
    /*height:
<?php echo $slider_description_height; ?> %;*/
<?php 
...
.huge_it_slideshow_title_text_gallery_<?php echo $galleryID; ?>.hidden, .huge_it_slideshow_description_text_gallery_<?php echo $galleryID; ?>.hidden {
    display: none;
}

.huge_it_gallery_like_cont_<?php echo $galleryID.$pID; ?>.none {
...
.huge_it_slideshow_dots_thumbnails_gallery_<?php echo $galleryID; ?> {
<?php if($gallery_default_params['gallery_img_slider_dots_position'] == "bottom"){?> bottom: 0;
<?php }else if($gallery_default_params['gallery_img_slider_dots_position'] == "none"){?> display: none;
<?php
}else{ ?> top: 0;
<?php } ?>
}
...
.youtube-icon {
    background: url(<?php echo GALLERY_IMG_IMAGES_URL.'/admin_images/play.youtube.png'; ?>) center center no-repeat;
}

.vimeo-icon {
    background: url(<?php echo GALLERY_IMG_IMAGES_URL.'/admin_images/play.vimeo.png'; ?>) center center no-repeat;
}
